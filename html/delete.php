<?php
	...
	$last=exec(sprintf("/home/socha/delete_vm %s %s",$vm,$ns),$out,$res);
	if($res == 0) {
		infome('Maszyna wirtualna <b>'.$vm.'</b> została usunięta.');
	} else {
		warnme('Wystąpił bład przy usuwaniu maszyny wirtualnej (' .$last. ').');
	}
	header('Location: /app.php');
